...
flowchart TB
    ...
    I --> MFU[Most Frequently Used<br/>mfu.go]
    ...
    LFU --> lfu_desc[Utiliza lista circular<br/>com menor contador de acessos de toda página]
    MFU --> mfu_desc[Utiliza lista circular<br/>com maior contador de acessos de toda página]
